...
/**
 * LunarCalc is a class that does lunar calculations that do not directly depend
 * on the lunar fundamentals (although some do need to call functions in Lunar).
 * <P>
 * The code in this class also uses other classes outside of Lunar (and some of
 * these classes in turn use Lunar), so these functions are in a separate class,
...
public class LunarCalc
{
    ...
    /**
     * The base Julian day for Ernest W. Brown's numbered series of lunations =
     * 1923 Jan 17 02:41 UT.
     * <P>
     * This date has been widely quoted as "Jan 16 1923" and indeed it was (in
     * EST) at Yale University where Prof. Brown worked.
     */
     ...
     * instance.
     *
     * @param cal - <TT>java.util.GregorianCalendar</TT> holding date for which
     * lunar age is required
     *
     * @return The lunar age in days (0.0 to 29.5306)
     */
    public static double ageOfMoonInDays(GregorianCalendar cal)
    {
        return ageOfMoonInDays(
                DateOps.dmyToDay(
     ...
     * <P>
     * A "lunation" is E. W. Brown's numbered series of lunar cycles. Lunation 1
     * was on January 16, 1923.
     *
     * @param jd Julian day
     *
    ...
    public static String summary(ObsInfo oi)
    {
        ...
        String info = "Lunation " + lunation(now) + ", age " + iDays + "d " + iHours + "h, \n";
    ...
    /**
     * Build a current lunar information summary String for Phila, PA, USA (a
     * shameless convenience function for dvaa.org).
     * <P>
     * The default summary contains the lunation, age in days, rise, and set
     * times for Philadelphia, PA, USA as the observer's location.
     *
     * @return The summary string
     */
    public static String summaryPHL()
    {
        return summary(new ObsInfo(new Latitude(39.95), new Longitude(-75.16))) + " (Phila, PA)";
    }
    ...
    /**
     * Calculate the relatively exact time of the lunar quarter change (NM, 1Q,
     * FM, or 3Q).
     * <P>
