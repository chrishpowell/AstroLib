...
public class DateOps
{
  ...
  */
  ...
  public static void main( String args[] )
  {
    ...
    double julianDay_AstroDate = astroDateUTC.jd() - TimeOps.tzOffset(utc)/Astro.HOURS_PER_DAY;  // Astrodate has no built-in TZ
    ...
    julianDay_AstroDate = astroDateNow.jd()-TimeOps.tzOffset(now)/Astro.HOURS_PER_DAY;  // Astrodate has no built-in TZ
