...
/**
 * A simple class used to store a pair of times. This is typically either a
 * rise/set or a start/end pair.
 */
public class TimePair
{
     ...
     */
    public TimePair(double a, double b)
    {
        this(a,b,0d);
    }
     ...
     */
    public TimePair(double a, double b, double c)
    {
        this.a = a;
        this.b = b;
        this.c = c;
